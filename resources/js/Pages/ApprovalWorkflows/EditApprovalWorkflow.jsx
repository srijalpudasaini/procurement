...
const AddApprovalWorkflow = ({ approval_workflow, roles }) => {
    const { data, setData, put, processing, errors, reset } = useForm({
        name: approval_workflow.name,
        min_amount: approval_workflow.min_amount,
        max_amount: approval_workflow.max_amount,
        steps: approval_workflow.steps.map(a => ({ step: a.step_number, role_id: a.role_id })),
    ...
    return (
        <AuthenticatedLayout>
            ...
            <div className="bg-white p-4 shadow sm:rounded-lg sm:p-8">
                <h2 className="text-center text-2xl font-bold">Edit Workflow</h2>
